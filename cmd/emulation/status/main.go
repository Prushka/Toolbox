...
func capabilityNames(capabilities emulation.Capability) []string {
	known := []struct {
		flag emulation.Capability
		name string
	}{
		{emulation.CapabilityKeyboard, "keyboard"},
		{emulation.CapabilityRelativeMouse, "relative mouse"},
		{emulation.CapabilityAbsoluteMouse, "absolute mouse"},
		{emulation.CapabilityHorizontalWheel, "horizontal wheel"},
		{emulation.CapabilityUSBDetach, "USB detach"},
	}
