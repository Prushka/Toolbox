...
var (
	errBadMagic    = errors.New("emulation: invalid frame magic")
	errBadVersion  = errors.New("emulation: unsupported protocol version")
	errBadChecksum = errors.New("emulation: frame checksum mismatch")
	errFrameLarge  = errors.New("emulation: frame payload is too large")
)
